...
function januas_register_metaboxmenu_field_type($field, $meta) {
    ...
    <ul>
        ...
        <li><a href="#januas_vendors"><?php _e('Vendors', 'januas'); ?></a></li>
